...
MAX_ACTION = 1.0   # Exemplo: Limite a entrada de controle
...
for eval_ep in range(NUM_EVAL_EPISODES):
    ...
    print(f"Avaliação {eval_ep+1}/{NUM_EVAL_EPISODES} | Steps: {step_count} | Recompensa Total: {eval_reward:.4f} | Setpoint: {env.setpoint}")
