from utils.networks import ActorNetwork_, CriticNetwork_
...
class DDPGAgent:
    def __init__(self, state_dim, action_dim, max_action,
        ...
        self.actor = ActorNetwork_(state_dim, action_dim, max_action).to(self.device)
        self.critic = CriticNetwork_(state_dim, action_dim).to(self.device)
        ...
        self.actor_target = ActorNetwork_(state_dim, action_dim, max_action).to(self.device)
        self.actor_target.load_state_dict(self.actor.state_dict())
        self.critic_target = CriticNetwork_(state_dim, action_dim).to(self.device)
