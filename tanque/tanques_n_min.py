...
class Quatro_Tanques:
    ...
    def reset(self, setpoint = [6.2,6.35] ):
    ...
    def step(self, actions_norm = [0,0], u=None):
        ...
        #reward1 += 0.1 * (1.0 - abs(error1_norm))
        #reward2 += 0.1 * (1.0 - abs(error2_norm))
        
        terminated = [False, False]

        if y1 > 20 or y2 > 20 or y1 < 0 or y2 < 0 or h3> 10 or h4>10:
        ...
        self.h3_hist.append(h3)
        self.h4_hist.append(h4)
        info = {}
